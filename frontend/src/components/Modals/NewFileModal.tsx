...
const NewFileModal = () => {
  ...
  return (
    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90%] md:w-[80%] lg:w-[40%] rounded-[20px] max-h-[80%] shadow-lg dark:bg-[#303030] dark:text-white flex flex-col">
      <div
