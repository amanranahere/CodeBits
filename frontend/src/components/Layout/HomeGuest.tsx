...
export default function HomeGuest() {
  ...
  return (
    <div className="w-full">
      ...
      <div
        onClick={toggleLogin}
        className="fixed top-1 right-1 md:top-8 md:right-12 z-[999] py-2 px-4 flex justify-center items-center gap-x-1 md:gap-x-2 rounded-full hover:bg-[#2a2a2a] active:bg-[#3a3a3a] duration-150 cursor-pointer select-none hover:brightness-150"
      >
