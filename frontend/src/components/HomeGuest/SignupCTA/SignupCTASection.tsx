...
export default function SignupCTASection() {
  ...
  return (
    <section className="min-h-screen w-full flex flex-col justify-center items-center gap-y-6 md:gap-y-10 py-16 mb-20 lg:mb-16 md:py-24 lg:py-28 px-4 md:px-10 bg-black">
      <div className="flex flex-col justify-center items-center gap-y-3  md:gap-y-6 text-center">
        ...
        <motion.p
          ...
          viewport={{ once: true, amount: 0.2 }}
          className="w-full lg:w-[70%] text-[#bababa] text-sm md:text-lg font-medium text-center leading-tight"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
          className="flex justify-center items-center gap-x-3 md:gap-x-8 mt-4"
        >
          <button
